...
public class Card
{
    ...
    /**
     * determinePointValue method -- returns the point value for the card -- 11 
     * if Ace is high, 1 if Ace is low, 10 for a face card, the actual value 
     * for cards 2 through 10
     * @param aceHigh true if the ace has a high value of 11, false if it 
     * has a low value of 1
